...
\begin{align}
  \mathcal{L}_{0} f = \lim_{t \to 0} \frac{T_t^0 f \- f}{t}, 
\end{align}
...
\begin{align\*}
  \mathcal{L}_0f = \sum_{i =1 }^d a_i(x) \frac{\partial f}{\partial x_i} + \frac{1}{2} \sum_{i,j = 1}^d (b(x)b(x)^\*)_{ij} \frac{\partial^2 f}{\partial x_i\partial x_j}. 
\end{align\*}
...
\begin{align}
  \left\lVert T_t^0 f - \int f\, d\pi \right\rVert \le Ce^{-\lambda_0 t} \left \| f- \int f \, d\pi \right\|
\end{align}
